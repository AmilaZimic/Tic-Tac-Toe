...
public class OnePlayerStart extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_one_player_start);
    }
    ...
    public void submitName(View view) {
        ...
        Intent intent = new Intent(this,OnePlayerPlaysGame.class);
